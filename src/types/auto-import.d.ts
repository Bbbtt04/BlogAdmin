...
declare global {
  ...
  const useAsyncRoute: typeof import('../store/modules/asyncRoute')['useAsyncRoute']
  const useAsyncRouteWithOut: typeof import('../store/modules/asyncRoute')['useAsyncRouteWithOut']
  ...
  const useSelected: typeof import('../hooks/useSelected')['default']
